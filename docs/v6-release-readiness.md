...
- README badge, update line, changelog pointer, eval metadata, validator expectations, examples, and active docs must agree with `metadata.version` in the root `SKILL.md`.
