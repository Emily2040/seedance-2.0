...
*What Seedance 2.0 is best at, how to extract each strength, and what to design around. Load before prompt planning. Labels: [official] = ByteDance/fal/Ark docs · [field] = practitioner-reported · [heuristic] = default to test. Last verified 2026-06-09. Diagnostic hypotheses and their limits live in `model-mechanics.md`; they do not prove the claims in this map.*
...
| Formats and duration [surface-specific] | Choose the delivery ratio and a supported duration; use `auto` only when documented for that endpoint |
